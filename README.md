...
I'm currently working on **FLITS**, an MVP web app that models the profit, revenue, cost, and emissions impact of changes to a fruit shipping process. I'm writing the calculations in Python, then porting them through TypeScript into JavaScript, and wiring them into the frontend.

I'm also getting started on a project training models to predict shipping energy use from weather forecast data, working through data prep and model selection right now.
